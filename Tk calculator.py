...
# Create and place buttons using a grid
row_val = 1
col_val = 0

for button in buttons:
    # We use a lambda function to pass the specific button text to the function
...
# Configure grid weights so buttons resize evenly
for i in range(4):
